            ...
            <Container fluid="md">
                ...
                <Form>
                    ...
                    <Modal.Footer style={{ backgroundColor: "#404044", color: "white" }}>
                        <Button variant="secondary" onClick={this.props.handleItemAdded}>Close</Button>
                        { showSupmit ? <Button variant="success" onClick={this.onSubmit} >+ Add Monitor</Button> : null }
                    </Modal.Footer>
                </Modal>
            </Container>
        )
