...
class EditMonitor extends Component {
    ...
    render() {
        ...
        return (            
            <Container fluid="md">
                <br />
                <h5 className="text-center">Edit Monitor</h5>                 
                ...
                <Form>
                    ...
                    <Form.Group controlId="event-channel">
                        ...
                        <Form.Text className="text-muted">
                            Enter the name of the discord channal that will receive alert messages.
                        </Form.Text>
                    ...
                    { showSupmit ? <Button variant="outline-success" onClick={this.onSubmit}>Edit Monitor</Button> : null }
